export default function ContactButtons() {
  return (
    <div className="mt-6 grid w-full gap-2 [grid-template-columns:repeat(auto-fit,minmax(160px,1fr))]">
      <a
        className="btn btn-outline btn-primary align-center hover:btn-secondary"
      ...
      {/* <a className="btn align-center" href="./projects">
            <svg
