...
<div class="not-prose grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
  <div class="stat bg-base-300 rounded-xl p-4 shadow">
    <div class="stat-title text-xs text-base-content">Teams Mentored</div>
    <div class="stat-value text-2xl text-primary">2</div>
    <div class="stat-desc text-base-content">Duke Foundry teams</div>
  </div>
  <div class="stat bg-base-300 rounded-xl p-4 shadow">
    <div class="stat-title text-xs text-base-content">Budget Target</div>
    <div class="stat-value text-2xl text-secondary">$50</div>
    <div class="stat-desc text-base-content">Both teams passed</div>
  </div>
  <div class="stat bg-base-300 rounded-xl p-4 shadow">
    <div class="stat-title text-xs text-base-content">GPS Accuracy</div>
    <div class="stat-value text-2xl text-accent">+8.7%</div>
    <div class="stat-desc text-base-content">Distance error (Team 1)</div>
  </div>
  <div class="stat bg-base-300 rounded-xl p-4 shadow">
    <div class="stat-title text-xs text-base-content">Lightest Build</div>
    <div class="stat-value text-2xl text-info">65 g</div>
    <div class="stat-desc text-base-content">2.3 oz (Team 2)</div>
  </div>
</div>
...
- **Frontend:** HTML/CSS/JS web app where users set target activity levels and view the past two days of stats
